...
const CreateNoteForm: FC<CreateNoteFormProps> = memo(({ onClose }) => {
  ...
  return (
    <div className="relative z-10 create-note-form-container"
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div
            ...
            <form className="create-note-form" onSubmit={event => handleSubmit(event)}>
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                  ...
                  <h3 className="text-base font-semibold leading-6 text-gray-900 text-xl mb-5" id="modal-title">Create note</h3>
                  <div className="mb-2">
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button type="submit"
                        className="outline-none submit-create-note-form-button inline-flex w-full justify-center rounded-md bg-emerald-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-400 sm:ml-3 sm:w-auto"
                >
                  Create
                </button>
                <button type="button"
                        className="close-create-note-form-button mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                        onClick={() => onClose()}
                >
                  Cancel
                </button>
